...
function search(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var search_1, resp, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    search_1 = req.query.q;
                    return [4 /*yield*/, itemService.list(search_1)];
                case 1:
                    resp = _a.sent();
                    return [2 /*return*/, res.status(200).json(resp)];
                case 2:
...
function validateParams(_a) {
    var schema = _a.schema;
    return function (req, res, next) {
        var result = schema.validate(req, { abortEarly: false });
        if (result.error) {
            var details = result.error.details;
            var errorList = utils_1.validationMessage(details);
